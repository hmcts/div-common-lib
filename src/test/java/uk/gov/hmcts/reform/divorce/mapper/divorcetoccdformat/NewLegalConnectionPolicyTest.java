...
public class NewLegalConnectionPolicyTest {
    ...
    @Test
    public void shouldMapAllAndTransformNewLegalConnectionPolicy() throws URISyntaxException, IOException {

        CoreCaseData expectedCoreCaseData = ObjectMapperTestUtil
            .retrieveFileContentsAsObject("fixtures/divorcetoccdmapping/ccd/newLegalConnectionPolicy.json", CoreCaseData.class);
        ...
        DivorceSession divorceSession = ObjectMapperTestUtil.retrieveFileContentsAsObject(
            "fixtures/divorcetoccdmapping/divorce/newLegalConnectionPolicy.json", DivorceSession.class);
