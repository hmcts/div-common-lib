...
public class JurisdictionConnectionNewPolicyTest {
    ...
    @Test
    public void shouldMapAllAndTransformNewJurisdictionFields()
            throws URISyntaxException, IOException {

        CoreCaseData caseData = ObjectMapperTestUtil
                .retrieveFileContentsAsObject("fixtures/ccdtodivorcemapping/ccd/jurisdictionConnectionNewPolicy.json",
                        CoreCaseData.class);

        DivorceSession expectedDivorceSession = ObjectMapperTestUtil.retrieveFileContentsAsObject(
                "fixtures/ccdtodivorcemapping/divorce/jurisdictionConnectionNewPolicy.json",
